package com.sapient.mongoDB.services;
...
import com.sapient.mongoDB.contracts.IEmployeeDAO;
...
public class EmployeeService implements IEmployeeDAO {
	...
	public EmployeeService() {
		...
		collection = MongoUtil.getCollectionFromDB("bitandb", "emps", Employee.class);
	}
