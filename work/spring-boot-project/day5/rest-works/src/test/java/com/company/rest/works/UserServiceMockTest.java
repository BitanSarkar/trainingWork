...
//	@DisplayName(value = "whenProducts_thenCheckForMinimumOneEntry")
	void whenAllUsers_thenCheckForMinimumOneEntryMock() {
...
//	@DisplayName(value = "Check if User with given ID exists")
	void whenUserIdGiven_thenCheckIfExistsTestMock() {		
		assertEquals("Joe", userService.getUserByIdAsObject(101).getName());
	}
